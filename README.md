...
<div class="game-container">
    ...
    <iframe id="gameFrame9" src="https://schoolpizzaparty.q-station.net/" width="800" height="600"></iframe>
    <br>
    <button onclick="toggleFullScreen('gameFrame9')">Go Full Screen</button>
</div>

<div class="game-container">
    <h3>Eaglercraft</h3>
    <iframe id="gameFrame10" src="https://yourkingisme.github.io/2/" width="800" height="600"></iframe>
    <br>
    <button onclick="toggleFullScreen('gameFrame10')">Go Full Screen</button>
</div>

<div class="game-container">
    <h3>Ragdoll Hit</h3>
    <iframe id="gameFrame11"https://codex-gg.github.io/VIP/games/ragdollhit/index.html" width="800" height="600"></iframe>
    <br>
